...
import 'package:iub_student_monitoring_system/presentation/desktop_view/dashboard.dart';
...
void main() async {
  ...
  await databaseProvider.loadDatabase('db.sqlite3', 'new_db.sqlite3');
    ...
    return BlocProvider<AuthBloc>(
        ...
        child: ScreenUtilInit(
          ...
          builder: () => MaterialApp(
            ...
            home: Platform.isAndroid ? LoginPage() : const DashBoard(),
